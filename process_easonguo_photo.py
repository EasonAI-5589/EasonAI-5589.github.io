#!/usr/bin/env python3
"""
处理easonguo.PNG照片，调整到合适的比例用于网站头像
"""

from PIL import Image
import os

def process_easonguo_photo(input_path, output_path, target_size=(400, 400)):
    """
    处理easonguo.PNG照片，调整到合适的比例
...
if __name__ == "__main__":
    ...
    print("开始处理easonguo.PNG照片...")
    process_easonguo_photo(input_photo, output_photo, target_size=(400, 400))
    print("照片处理完成！")
